...
//        long startTime = System.currentTimeMillis();
        ...
        System.out.println( (i-1) + " th step: " + x_Initial + " -> convergence :" + FunctionUtil.Q9.func( x_Initial ) );

        while( i < iterationMax ) {

            x_Approx = FunctionUtil.Q9.gFunc( x_Initial );

            System.out.println( (i) + " th step: " + x_Approx + " -> convergence :" + FunctionUtil.Q9.func( x_Approx ) );
